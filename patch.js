...
const endStr = '             background-color: transparent !important;\n          }\n        }\n      `}</style>';
...
if (startIndex !== -1 && endIndex !== -1) {
  const replacement = `      <style>{\`
        @media print {
          ...
          /* Exceções para cores originais do gráfico/relatório: manter textos de turmas, progresso, ícones coloridos etc. */
          /* As classes text-emerald-*, text-cyan-*, etc., não serão afetadas, mantendo o gráfico colorido. */
