...
function RelatorioAvaliacaoAdminContent() {
  ...
  if (userLoading || loading) {
    return (
      <div className="flex h-[75vh] items-center justify-center bg-slate-50 print:bg-white p-4">
  ...
  if (migratingMessage) {
    return (
      <div className="max-w-2xl mx-auto my-12 p-8 bg-white border border-rose-100 rounded-xl shadow-sm">
        ...
        <div className="bg-slate-50 print:bg-white p-4 border rounded-lg mb-6">
  ...
  return (
    <div 
      ...
      className={`official-document-sheet max-w-7xl mx-auto px-4 py-8 space-y-8 print:space-y-2 print:py-0 print:px-0 print:max-w-none print:bg-white print:text-black `}
    >
      <style>{`
  @media print {
...
`}</style>
      ...
      {/* FILTER BOX */}
      <div className="bg-white dark:bg-slate-900 print:bg-white text-slate-900 dark:text-white print:text-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm p-6 print:hidden">
        <div className="flex items-center gap-2 mb-4 border-b border-slate-200 dark:border-slate-800 pb-2.5">
          <SlidersHorizontal className="h-4 w-4 text-slate-700 dark:text-slate-300" />
          <h2 className="text-xs font-black uppercase tracking-wider font-mono text-slate-900 dark:text-white">Filtros de Pesquisa e Segmentação</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Turma Selection */}
          <div>
            <label className="block text-xs text-slate-700 dark:text-slate-200 font-bold uppercase tracking-wider mb-1.5 font-mono">Turma</label>
            <select
              value={selectedTurma}
              onChange={(e) => {
              ...
              className="w-full bg-white dark:bg-slate-950 print:bg-white border border-slate-300 dark:border-slate-700 text-xs rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-sky-400 text-slate-900 dark:text-white font-medium cursor-pointer shadow-sm"
            >
              <option value="ALL" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Todas as Turmas</option>
              {turmas.map(t => (
                <option key={t.id} value={t.id} className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">{t.nome}</option>
              ))}
            </select>
          </div>
          ...
          {/* Instrutor Selection */}
          <div>
            <label className="block text-xs text-slate-700 dark:text-slate-200 font-bold uppercase tracking-wider mb-1.5 font-mono">Instrutor</label>
            <select
              value={selectedInstructor}
              onChange={(e) => setSelectedInstructor(e.target.value)}
              className="w-full bg-white dark:bg-slate-950 print:bg-white border border-slate-300 dark:border-slate-700 text-xs rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-sky-400 text-slate-900 dark:text-white font-medium cursor-pointer shadow-sm"
            >
              <option value="ALL" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">Todos os Instrutores</option>
              {instructorsList.map(inst => (
                <option key={inst} value={inst} className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">{inst}</option>
              ))}
            </select>
          </div>
        </div>
        ...
        {/* Filters Clear Row */}
        <div className="flex justify-between items-center mt-4 border-t border-slate-200 dark:border-slate-800 pt-3 text-xs">
          <span className="text-slate-600 dark:text-slate-300 font-mono">
            Registros encontrados para o filtro selecionado: <strong className="text-slate-900 dark:text-white font-bold">{filteredSubmissions.length} avaliações</strong>
          </span>
          <button
            onClick={clearAllFilters}
            className="flex items-center gap-1.5 text-rose-600 hover:text-rose-700 dark:text-rose-400 dark:hover:text-rose-300 transition font-bold cursor-pointer"
          >
        ...
        (() => {
          ...
          return (
            <motion.div 
              ...
              className="mt-6 bg-slate-50 print:bg-white border border-slate-200 rounded-xl p-5 shadow-sm flex flex-col md:flex-row items-center gap-6 print:hidden"
            >
              ...
              <div className="flex-1 space-y-4 text-center md:text-left w-full">
                <div>
                  <span className="text-[10px] bg-slate-900 print:bg-white text-white print:text-slate-900 font-mono font-bold px-2 py-0.5 rounded uppercase tracking-wider">Acesso Livre - Sem Login</span>
                ...
                <div className="bg-white border rounded-lg p-3 max-w-xl text-slate-900">
                  ...
                  <div className="w-full bg-slate-100 print:bg-white h-2 rounded-full overflow-hidden">
                    <div 
                ...
                <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                  ...
                  <a
                    ...
                    className="flex items-center gap-1.5 bg-white hover:bg-slate-50 print:bg-white border border-slate-200 text-slate-700 text-xs font-bold px-4 py-2 rounded-lg transition"
                  >
      ...
      {!hasActiveFilter ? (
        <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center shadow-sm max-w-xl mx-auto my-8 space-y-4">
          <div className="w-16 h-16 bg-slate-50 print:bg-white border rounded-2xl flex items-center justify-center mx-auto shadow-sm">
                  ...
                  <div className="space-y-6 animate-fade-in">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm flex items-center justify-between">
                        ...
                        <div className="w-12 h-12 bg-slate-50 print:bg-white rounded-lg flex items-center justify-center border">
                    ...
                    <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                      ...
                      <div className="h-3 bg-slate-100 print:bg-white rounded-full overflow-hidden">
                        <div 
                        ...
                        <div className="space-y-6 mt-6 pt-6 border-t border-slate-200/60">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                              ...
                              <div className="flex items-center gap-2 bg-slate-100 print:hidden border border-slate-200 p-1 rounded-xl shadow-inner text-[10px] font-bold font-mono">
                                ...
                                <button
                                  ...
                                  className={`px-3 py-1.5 rounded-lg transition-all duration-150 flex items-center gap-1.5 font-black uppercase text-[9px] tracking-wider active:translate-y-[2px] active:border-b-[1px] ${
                                    chartTheme === 'azul'
                                      ? 'bg-slate-950 print:bg-white text-cyan-400 border border-cyan-500 shadow-[0_0_15px_rgba(6,182,212,0.45)] border-b-[4px] border-r-[2px] border-cyan-405'
                              ...
                              <div className="text-[10px] bg-slate-50 print:bg-white border border-slate-200 text-slate-805 font-bold px-3 py-2 rounded-lg font-mono shadow-sm">
  ...
  { name: 'Discordo (★1-2)', value: (distribution[1] || 0) + (distribution[2] || 0), color: '#ef4444' }
                ...
                {filteredPendingStudents.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filteredPendingStudents.map((stud, index) => (
                      <div key={`pending-${stud.id || index}`} className="border border-slate-150 rounded-xl p-4 bg-slate-50 print:bg-white hover:bg-slate-100 print:bg-white transition flex flex-col justify-between space-y-3">
                        <div className="space-y-1">
                          <div className="text-xs font-bold text-slate-800 flex items-center gap-1.5 font-mono">
                            {stud.posto_graduacao ? (
                              <span className="bg-slate-200/85 text-slate-700 text-xs font-bold px-1.5 py-0.5 rounded uppercase font-mono">
                                {stud.posto_graduacao}
                              </span>
                            ) : null}
                            <span className="text-xs font-bold">{stud.nome}</span>
                          </div>
                          <p className="text-[10px] text-slate-500 font-mono">
                ...
                {filteredRespondedStudents.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filteredRespondedStudents.map((stud, index) => (
                      <div key={`responded-${stud.id || index}`} className="border border-slate-150 rounded-xl p-4 bg-slate-50 print:bg-white hover:bg-slate-100 print:bg-white transition flex flex-col justify-between space-y-3">
                        <div className="space-y-1">
                          <div className="text-xs font-bold text-slate-800 flex items-center gap-1.5 font-mono">
                            {stud.posto_graduacao ? (
                              <span className="bg-slate-200/85 text-slate-700 text-xs font-bold px-1.5 py-0.5 rounded uppercase font-mono">
                    ...
                    {CURSO_QUESTIONS.map((q, idx) => {
                      ...
                      return (
                        <div key={q.key} className="border border-slate-100 rounded-lg p-5 hover:bg-slate-50 print:bg-white transition">
                          ...
                          <div className="h-2 bg-slate-100 print:bg-white rounded-full overflow-hidden">
                            <div 
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm print:hidden">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  ...
                  <select
                    ...
                    className="bg-slate-100 print:bg-white border text-xs px-3 py-2 rounded-lg font-semibold focus:outline-none focus:ring-1 text-slate-800 w-full md:w-64"
                  >
          ...
          {activeTab === 'aluno' && (
            <div className="space-y-8">
              ...
              {focusedStudent && (
                <div className="bg-slate-50 print:bg-white border border-slate-200 rounded-xl p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 shadow-sm print:hidden">
                ...
                (() => {
                          ...
                          <form onSubmit={(e) => handleAdminSubmit(e, studentDetails)} className="space-y-8">
                                          ...
                                          <button
                                            ...
                                            className={`px-2.5 py-1.5 rounded-lg border text-[11px] font-mono font-bold flex items-center justify-center transition-all cursor-pointer ${
                                              isSelected
                                                ...
                                                : "bg-slate-50 print:bg-white border-slate-200 text-slate-600 hover:bg-slate-100 print:bg-white"
                                            }`}
                                          >
                                            {label}
                                          </button>
                                          ...
                                          return (
                                            <button
                                              ...
                                              className={`px-2.5 py-1.5 rounded-lg border text-[11px] font-mono font-bold flex items-center justify-center transition-all cursor-pointer ${
                                                isSelected
                                                  ? `${bgSel} font-black scale-105 shadow-md`
                                                  : "bg-slate-50 print:bg-white border-slate-200 text-slate-650 hover:bg-slate-100 print:bg-white"
                                              }`}
                                            >
                                              {label}
                                            </button>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                                <div className="space-y-1">
                                  ...
                                  <textarea
                                    ...
                                    rows={3}
                                    className="w-full text-xs text-slate-800 bg-slate-50 print:bg-white border border-slate-200 rounded-lg p-2.5 focus:bg-white focus:ring-1 focus:ring-slate-800 focus:outline-none"
                            ...
                            <div className="flex justify-end gap-3 border-t pt-5">
                              <button
                                ...
                                className="bg-white border text-xs px-5 py-2.5 rounded-lg text-slate-600 font-semibold hover:bg-slate-50 print:bg-white transition cursor-pointer"
                              >
                                Cancelar
                              </button>
                              <button
                      ...
                      <div className="bg-white border border-slate-200 rounded-xl p-8 text-center max-w-xl mx-auto shadow-sm space-y-5">
                        ...
                        <div>
                          ...
                          <p className="text-slate-500 text-xs mt-1.5 leading-relaxed">
                            O aluno <strong className="text-xl font-black text-slate-900 uppercase mx-1">{studentDetails?.posto_graduacao ? `${studentDetails.posto_graduacao} ` : ''}{studentDetails?.nome || "Selecionado"}</strong> ainda não enviou as respostas do questionário de conclusão.
                          </p>
                        </div>
                  ...
                  return (
                    <div className="space-y-8">
                        ...
                        <div className="md:col-span-2 space-y-4">
                          <div className="flex items-center justify-between gap-4">
                            <div className="flex items-center gap-3">
                              ...
                              <h3 className="text-3xl font-black text-slate-900 uppercase tracking-tight shadow-sm px-1" style={{ textShadow: "0 1px 2px rgba(0,0,0,0.1)" }}>
                                {studentSub.aluno?.posto_graduacao ? `${studentSub.aluno.posto_graduacao} ` : ''}{studentSub.aluno?.nome}
                              </h3>
                            </div>
                        ...
                        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-4">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="h-1.5 bg-slate-100 print:bg-white rounded-full">
                                ...
                                return (
                                  <div key={q.key} className="p-3.5 bg-slate-50 print:bg-white rounded-lg border border-slate-150 flex flex-col md:flex-row md:items-center md:justify-between gap-4 transition hover:bg-slate-50 print:bg-white">
                                    ...
                                    <div className="flex max-md:grid max-md:grid-cols-3 gap-2 shrink-0">
                                      {[
                                        { value: 5, label: "CONCORDO PLENAMENTE", activeClass: "bg-slate-900 print:bg-white text-white print:text-slate-900 border-slate-900 shadow-sm" },
                                        { value: 3, label: "CONCORDO PARCIALMENTE", activeClass: "bg-slate-900 print:bg-white text-white print:text-slate-900 border-slate-900 shadow-sm" },
                                        { value: 1, label: "DISCORDO/ NÃO SE APLICA", activeClass: "bg-slate-900 print:bg-white text-white print:text-slate-900 border-slate-900 shadow-sm" }
                                      ].map((opt) => {
                      ...
                      <div className="bg-slate-50 print:bg-white border border-slate-200 rounded-lg p-4 text-xs font-mono flex items-center justify-between">
                        <div>
                        ...
                        <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider bg-slate-100 print:bg-white border px-2 py-1 rounded">AUDITADO</span>
                      </div>
                      ...
                      <div className="flex justify-center pt-2 print:hidden">
                        <button
                          ...
                          className="flex items-center gap-2 bg-slate-100 print:bg-white hover:bg-slate-200 border border-slate-200 text-slate-800 text-xs font-bold uppercase tracking-wider font-mono px-6 py-3 rounded-lg transition-all cursor-pointer shadow-sm hover:shadow"
                        >
                          📊 Voltar para Estatísticas da Turma
                        </button>
                      </div>
...
export default function RelatorioAvaliacaoAdminPage() {
  return (
    <Suspense fallback={
      <div className="py-24 flex flex-col items-center justify-center bg-slate-50 print:bg-white min-h-[75vh] print:min-h-0 print:py-8">
